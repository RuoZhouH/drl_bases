...
def preprocess_point_data(map_json):
    ...
    return g_point_codes, g_point_coords, g_point_coord, storage_points, station_points, waiting_points
...
if __name__ == '__main__':
    ...
    cluster_point_map = {
        "cluster_4":["aEkBar", "QNih56", "mPFKwA", "Czc77c"],
        "cluster_5":["KEThKx", "ksm3CN", "Fd8nnD", "twynrT", "GPjaQm"]
    }
