...
def ini_fun():
    ...
    slope2_label = tk.Label(root, text='slope2').place(x=145, y=610, width=50, height=20)
    slope3_label = tk.Label(root, text='slope3').place(x=210, y=610, width=50, height=20)
    slope4_label = tk.Label(root, text='slope4').place(x=275, y=610, width=50, height=20)
    slope5_label = tk.Label(root, text='slope5').place(x=340, y=610, width=50, height=20)
    slope6_label = tk.Label(root, text='slope6').place(x=405, y=610, width=50, height=20)
    slope7_label = tk.Label(root, text='slope7').place(x=470, y=610, width=50, height=20)
    slope8_label = tk.Label(root, text='slope8').place(x=535, y=610, width=50, height=20)
    slope9_label = tk.Label(root, text='slope9').place(x=600, y=610, width=50, height=20)
...
def main():
    ...
    tk.Button(root, text='calculate', command=calculate).place(x=500, y=650, width=70, height=30)
    tk.Button(root, text='clear', command=clear).place(x=580, y=650, width=70, height=30)
    ...
    slope_frame = tk.Frame(root, highlightbackground='gray', highlightthickness=2).place(x=60, y=580, width=600,
                                                                                         height=2)
    button_frame = tk.Frame(root, highlightbackground='gray', highlightthickness=2).place(x=60, y=640, width=600,
                                                                                          height=2)
